...
public class Laberinto extends JFrame implements KeyListener, MouseListener
{	
	int x = 18, y = 36;
	...
	public TableroDibujo()
	{
		...
		try 
		{
		    img = ImageIO.read(new File("C:\\Users\\lachi\\OneDrive\\Documentos\\Documentos\\P2023JAVA\\130224Ventana\\src\\Act160424_TableroDibujo\\kitty.png"));
		} 
		catch (IOException e) 
		{
		    e.printStackTrace();
		...
		try 
		{
		    img1 = ImageIO.read(new File("C:\\Users\\lachi\\OneDrive\\Documentos\\Documentos\\P2023JAVA\\130224Ventana\\src\\Act160424_TableroDibujo\\fish1.png"));
		} 
		catch (IOException e) 
		{
		    e.printStackTrace();
